        ...
        >
            <div className="product-card-image-wrap">
                ...
                {product.stock !== undefined && product.stock !== null && (() => {
                    ...
                    if (s <= 0) return <span className="product-card-stock-badge product-card-stock-badge--out">Out of Stock</span>;
                    if (s <= 3) return <span className="product-card-stock-badge product-card-stock-badge--low">Only {s} left</span>;
                    return null;
                })()}
                {hovered && (
